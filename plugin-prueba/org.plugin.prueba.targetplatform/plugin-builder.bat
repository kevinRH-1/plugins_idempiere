...
call mvn validate -Didempiere.target=org.plugin.prueba.p2.targetplatform %DEBUG_MODE%
call mvn verify -Didempiere.target=org.plugin.prueba.p2.targetplatform %DEBUG_MODE%
