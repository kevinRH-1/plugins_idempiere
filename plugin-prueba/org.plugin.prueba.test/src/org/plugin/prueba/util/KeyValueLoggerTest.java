...
package org.plugin.prueba.util;

import static org.plugin.prueba.test.util.RandomTestUtil.*;
import static org.plugin.prueba.test.util.ReflectionTestUtil.*;
...
class KeyValueLoggerTest {
	...
	void shouldPrintClassFromClass() {
		...
		verifyStringLog(Level.INFO, "class=\"org.plugin.prueba.util.KeyValueLogger\"");
	}
	...
	void shouldPrintPackageFromClass() {
		...
		verifyStringLog(Level.INFO, "package=\"org.plugin.prueba.util\"");
	}
