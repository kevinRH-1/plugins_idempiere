...
package org.idempiere.prueba.util;

import static org.idempiere.prueba.test.util.RandomTestUtil.*;
import static org.idempiere.prueba.test.util.ReflectionTestUtil.*;
...
class KeyValueLoggerTest {
	...
	void shouldPrintClassFromClass() {
		...
		verifyStringLog(Level.INFO, "class=\"org.idempiere.prueba.util.KeyValueLogger\"");
	}
	...
	void shouldPrintPackageFromClass() {
		...
		verifyStringLog(Level.INFO, "package=\"org.idempiere.prueba.util\"");
	}
