# idempiere prueba api - Target Platform
...
-  `./pom.xml`
- `org.idempiere.prueba.p2.targetplatform/org.idempiere.prueba.p2.targetplatform.target`
- `org.idempiere.prueba.p2.targetplatform/pom.xml`
