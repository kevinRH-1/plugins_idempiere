...
call mvn validate -Didempiere.target=org.idempiere.prueba.p2.targetplatform %DEBUG_MODE%
call mvn verify -Didempiere.target=org.idempiere.prueba.p2.targetplatform %DEBUG_MODE%
